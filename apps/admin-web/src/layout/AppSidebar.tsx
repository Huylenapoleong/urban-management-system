...
const getNavItems = (t: (key: string) => string): NavItem[] => [
  ...
  },
  {
    ...
    subItems: [
      ...
      {
        name: t('navigation.exportReports'),
        path: '/export-reports',
        pro: false,
      },
    ],
...
const getOthersItems = (t: (key: string) => string): NavItem[] => [
  {
    ...
    subItems: [
      {
        name: t('navigation.chatbotConfig'),
...
const AppSidebar: React.FC = () => {
  ...
  const othersItems = useMemo(() => getOthersItems(t), [t]);
      ...
      >
        {isExpanded || isHovered || isMobileOpen ? (
          ...
          <div className="flex items-center gap-3">
            {/* Avatar */}
            <div className="w-9 h-9 rounded-full bg-linear-to-br from-blue-400 to-blue-600 flex items-center justify-center text-white text-xs font-bold shrink-0">
              {user?.avatarUrl ? (
                <img
                  src={user.avatarUrl}
                  alt={user.name}
          ...
          <div className="relative group">
            <div className="w-9 h-9 rounded-full bg-linear-to-br from-blue-400 to-blue-600 flex items-center justify-center text-white text-xs font-bold cursor-pointer">
              {user?.avatarUrl ? (
                <img
                  src={user.avatarUrl}
                  alt={user?.name}
